        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> <a href=""></a> Edit Article</li>
                    <li class="breadcrumb-item active"> <a href=""></a> <?php echo $article['title'] ?></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary">
                    ...
                    <form name="categoryForm" id="categoryForm" method="post" action="<?php echo base_url().'admin/article/edit/'.$article['id'] ?>" enctype="multipart/form-data" >
                        <div class="card-body">
