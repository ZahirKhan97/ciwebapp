        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> <a href="<?php echo base_url().'admin/category/index'; ?>"> Categories</a></li>
                    <li class="breadcrumb-item active"> <a href=""></a> Edit Category</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if ($category['image'] != "" && file_exists('./public/uploads/category/'.$category['image'])) { ?>
                                        <img width="300" class="mt-3" src="<?php echo base_url().'public/uploads/category/'.$category['image'] ?>" alt="image">
                                        <?php } else { ?>
                                            <img width="300" src="<?php echo base_url().'public/uploads/category/no image.png'; ?>">
                                            <?php } ?>
                                </div>
                                ...
                                <div class="custom-control custom-radio float-left ml-3">
                                    <input class="custom-control-input" value="0" type="radio" id="statusBlock"
                                        name="status"  <?php echo ($category['status'] == 0) ? 'checked' : ''; ?> >
